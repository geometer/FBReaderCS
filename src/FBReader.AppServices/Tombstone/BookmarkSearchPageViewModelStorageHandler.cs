...
{
    class BookmarkSearchPageViewModelStorageHandler : StorageHandler<BookmarkSearchPageViewModel>
    {
        public override void Configure()
        {
            Property(vm => vm.Query).InPhoneState();
            Property(vm => vm.BookId).InPhoneState();
            Property(vm => vm.SearchBookSubtitle).InPhoneState();
