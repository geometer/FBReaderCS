...
{
    public class CatalogSearchPageStorageHandler : StorageHandler<CatalogSearchPageViewModel>
    {
        ...
        public override void Save(CatalogSearchPageViewModel instance, StorageMode mode)
        {
