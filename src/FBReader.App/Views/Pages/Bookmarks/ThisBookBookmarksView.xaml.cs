...
{
    public partial class ThisBookBookmarksView : UserControl
    {
        private RadDataBoundListBoxItem _focusedItem;

        private ThisBookBookmarksViewModel ViewModel
        {
            get
            {
                return (ThisBookBookmarksViewModel) DataContext;
            }
        }

        public ThisBookBookmarksView()
        {
            InitializeComponent();

            RadContextMenu.SetFocusedElementType(List, typeof(RadDataBoundListBoxItem));
        }
